...
create index if not exists dentle_case_reports_case_idx on public.dentle_case_reports (case_id, board_date, review_cycle);
create index if not exists dentle_case_reports_created_at_idx on public.dentle_case_reports (created_at desc);
create index if not exists dentle_case_moderation_status_idx on public.dentle_case_moderation (status, last_reported_at desc);
